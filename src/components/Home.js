    ...
    return(
      <div>
       ...
       <div className="about">
         ...
         <hr id="line1"></hr>
         <p id="about-content">The Eleventh National Level Technical Symposium is going to be conducted at a grand level which includes several most advanced technical workshops and events to enhance their skills also there are some dazzling performances by our youngsters at this event. We are going to embrace the present technological advancement. So we the youngsters of the new technical era promise you, that this two day technical event is worth your time as you are going to enhance your technical skill, test your knowledge resources and can have a blast during the culturals. Our IT YUKTA is a mix of knowledge and entertainment. So Please do join us on <b id="dates"> 17th & 18th of March 2023.</b></p>
       </div>
       </div>
       ...
       <div id="e-total">
        ...
        <div id="e-head2">
          ...
          <p id="m-co-d">Contact no:<a style={{textDecoration:"none"}}href='tel:9381690958'>9381690958</a></p>
          </div>
          </div>
          <div id="fe-co" >
          <div id="fe-co-logo">
          ...
          <p id="fe-co-d">Contact no:<a style={{textDecoration:"none"}} href='tel:8978780424'>8978780424</a></p>
          </div>
          </div>
       ...
       <div className="dance">
        ...
        <div id="cul">
          ...
          <div id="cul-content">
             ...
             <p id="e-matter">
             Cultural events provide an opportunity for people to come together and learn more about the traditions, customs, and beliefs of a particular culture.It is conducted on <b style={{color:"#FF9900"}}>17-03-2023</b>
             </p>
          </div>
        </div>
        <div id="fb">
          <div id="fb-content">
          <p id="e-head"style={{textAlign:'right'}}>Flash Mob</p><br/>
          <p id="e-matter">
          A flashmob is a type of impromptu performance where a group of people suddenly come together in a public space to perform a coordinated action, such as a dance or a musical performance.It is conducted on <b style={{color:"#FF9900"}}>18-03-2023</b>
             </p>
          </div>
          <div id="fb-logo">
       ...
       <hr id="line4"></hr>
       <p id="g-reg-content" >
        <div ref={target2} className={`animate__animated ${isVisible2 ? 'animate__zoomIn' : ''}`} onAnimationEnd={onAnimationEnd}>
        This General Registration gives the allowance to register in any WORKSHOP or EVENT.<br/>
        So for any candidate to parctipate in ane WORKSHOP or EVENT must have to pay the general registration fee.<br/>
        This Registration give the permisson to allow you into the fest and also it acts as an entry fee to the fest.<br/><br/>
